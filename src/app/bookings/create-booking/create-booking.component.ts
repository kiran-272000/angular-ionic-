    ...
    this.form = new FormGroup(
      {
        ...
        from: new FormControl(this.startDate, {
          updateOn: "blur",
          validators: [Validators.required],
        }),
        to: new FormControl(this.endDate, {
          updateOn: "blur",
          validators: [Validators.required],
        }),
      },
    ...
    this.modalCtrl.dismiss(
      {
        bookingData: {
          ...
          checkIn: new Date(this.form.value.from),
          checkOut: new Date(this.form.value.to),
        },
      },
      "confirm"
    );
  ...
  dateValidator(from, to): ValidatorFn {
    return (control: AbstractControl): ValidationErrors | null => {
      ...
      if (endDate < startDate) {
        return { "To date must be after from date": true };
      }
      return null;
    };
  }
